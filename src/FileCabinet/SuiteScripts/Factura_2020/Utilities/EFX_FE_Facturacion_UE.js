 ...
 */
define(['N/record', 'N/search', 'N/runtime', './EFX_FE_Importe_en_Letra_ST', 'N/record', 'N/currency', 'N/config', './moment.js', 'N/query', 'N/file', 'N/format', 'N/ui/serverWidget', 'N/ui/message', 'N/url', 'N/https', 'N/query'],
    /**
     * @param{record} record
     */
    function (record, search, runtime, mod_monto_letra, modRecord, modcurrency, config, moment, query, file, format, serverWidget, message, url, https, query) {
        ...
        function beforeSubmit(context) {
            ...
            // ! Modificación para la dirección de clientes en pagos
            if (recType == record.Type.CUSTOMER_PAYMENT) {
                if (clienteObj) {
                    try {
                        ...
                        if (dir_cliente) {
                            newRec.setValue({ fieldId: 'custbody_tko_dir_cliente', value: dir_cliente });
                        }
                    } catch (err_dir) {
                        log.error({ title: 'Error al tratar de obtener direccion', details: err_dir });
                    }
                }
            }
